 ...
 */
public class MinesweeperExpert extends JFrame implements IMinesweeper{
    /**
     ...
     */
    public MinesweeperExpert(){
        super("Minesweeper - Expert");
        gameMenu.setDifficulty(new Difficulty("Expert"));
    ...
    public void initComponents( GameBoard board){
        ...
        topPanel = new JPanel();
        topPanel.setMaximumSize(new Dimension(1240,80));
