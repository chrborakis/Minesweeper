 ...
 */
public class MinesweeperIntermediate extends JFrame implements IMinesweeper{
    /**
     ...
     */
    public MinesweeperIntermediate(){
        super("Minesweeper - Intermediate");
        gameMenu.setDifficulty(new Difficulty("Intermediate"));
